...
class Coin(arcade.Sprite):
    ...
    def update(self):
        ...
        #check if coin is passed the buttom
        if self.top < 0:
            self.reset_pos()
...
class MyGame(arcade.Window):
    def __init__(self):
        """Initalizer
        call parent class Initalizer"""
        super().__init__(SCREEN_WIDTH, SCREEN_HEIGHT, "Coin Atsume")
    ...
    def on_draw(self):
        ...
        arcade.draw_text(output, 10, 20, arcade.color.AQUA, 14)

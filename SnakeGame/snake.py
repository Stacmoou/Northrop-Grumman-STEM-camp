...
HEAD = 0 # Syntactic sugar, 0 is the snake
...
def main():
    ...
    pygame.display.set_caption("Stacy the Silly Snake's Quest for Plums")
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Snake!', True, WHITE, PURPLE)
...
def drawScore(score):
    scoreSurf = BASICFONT.render('Plums: %s' % (score), True, WHITE)
